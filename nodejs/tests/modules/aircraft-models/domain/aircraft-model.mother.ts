import {
  AircraftModelCreateProps,
  AircraftModelPrimitiveProps,
  AircraftModelProps
} from 'src/modules/aircraft-models/domain/aircraft-model-types'
...
export class AircraftModelMother {
  static fromInput(input: Partial<AircraftModelPrimitiveProps>): AircraftModel {
    return AircraftModelBuilder.aModel()
      .withProps(input as Partial<AircraftModelProps>)
      .build()
  }
