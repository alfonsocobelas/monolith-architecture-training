Feature: Uninstall an engine from an aircraft
  ...
  Scenario: Fail to uninstall when engine does not exist
    ...
    When I send a POST request to "/api/v1/aircrafts/018e6e5a-7b32-7a5c-8d1f-3b3c3d3e3f01/engines/018f0000-0000-0000-0000-000000000000/uninstall" with body:
      """
      {}
      """
  ...
  Scenario: Fail to uninstall when aircraft does not exist
    ...
    When I send a POST request to "/api/v1/aircrafts/018f0000-0000-0000-0000-000000000000/engines/018e6e5a-7b32-7a5c-8d1f-3b3c3d3e3e01/uninstall" with body:
      """
      {}
      """
    Then the response status code should be 404
